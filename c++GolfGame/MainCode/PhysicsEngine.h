...
namespace PhysicsEngine
{
	...
	static const PxVec3 default_color(1.0f,1.0f,1.0f);
	...
	public:
		...
		//can be used to add additional shapes, call multiple times. 
	...
	public:
		Scene(PxSimulationFilterShader custom_filter_shader = PxDefaultSimulationFilterShader) : filterShader (custom_filter_shader) {}
